...
public class MainActivity extends Activity implements Fragment2.OnFragmentInteractionListener2,Fragment3.OnFragmentInteractionListener3, Fragment2.PasarContador{
int contador = 0;
    @Override
    ...
    public void PasarContador() {
        ...
        Fragment3 f3= (Fragment3)getFragmentManager().findFragmentById(R.id.canto_inferior_dret);
        if(f3 != null){
            f3.contadorTV.setText("CONTADOR: "+contador);
        }
    }
}
