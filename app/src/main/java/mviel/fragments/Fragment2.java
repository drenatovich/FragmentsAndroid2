...
public class Fragment2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        fl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pasCont.PasarContador();
            }
    });
        Toast.makeText(getContext(), "Se crea fragment 2", Toast.LENGTH_SHORT).show();
        return v;
    }
    ...
    public void onAttach(Activity activity) {
        ...
        try {
            ...
            pasCont = (PasarContador) activity;
    ...
    public void onDetach() {
        Toast.makeText(this.getContext(), "Eliminando Fragment 2", Toast.LENGTH_SHORT).show();
        super.onDetach();
        mListener = null;
    }
    ...
    public interface PasarContador {
